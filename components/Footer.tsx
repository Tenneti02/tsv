        ...
        <footer className="bg-black text-white py-16 px-4 border-t-8 border-neo-green font-mono relative overflow-hidden">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                <div className="col-span-1 md:col-span-2">
                    <h2 className="text-4xl font-black mb-6">TSVS.</h2>
                    <p className="text-gray-400 max-w-sm mb-4">
                        Designing for the future with the raw aesthetics of the past. No
                        cookies, no trackers, just code.
                    </p>
                    <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 text-xs text-gray-500">
                        <span className="w-2 h-2 bg-neo-green rounded-full animate-pulse"></span>
                        Built with ☕ + Next.js from Visakhapatnam
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <a
                            href="https://www.linkedin.com/in/tenneti-surya-venkata-subrahmanyam"
